...
class Sample : public xCore
{
	...
	SCameraModelView* m_pModelCamera;
...
public:
	...
	bool Init()
	{
		...
		m_pModelCamera = new SCameraModelView;
		m_pMainCamera->m_matProj = m_pMainCamera->m_matView;
...
GAME_RUN("SampleModelView", 800, 600)
