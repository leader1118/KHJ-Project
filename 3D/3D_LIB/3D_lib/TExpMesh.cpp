...
void TExpMesh::WriteColor(BYTE* pDest, const D3DXVECTOR4& Src, DWORD dwDestFormat)
{
	...
	case D3DDECLTYPE_FLOAT4:
		*reinterpret_cast<D3DXVECTOR4*>(pDest) = Src;
		break;
	case D3DDECLTYPE_FLOAT16_4:
		*reinterpret_cast<D3DXVECTOR4*>(pDest) = D3DXVECTOR4(Src.x, Src.y, Src.z, Src.z);
		break;
...
void TExpMesh::TransformAndWriteVector(BYTE* pDest, D3DXVECTOR3* normal, const D3DXVECTOR3& Src, DWORD dwDestFormat)
{
...
void TExpMesh::TransformPosition(D3DXVECTOR3* pDestPosition, const D3DXVECTOR3* pSrcPosition) const
{
...
void TExpMesh::TransformDirection(D3DXVECTOR3* pDestDirection, const D3DXVECTOR3* pSrcDirection) const
{
	D3DXVECTOR3 SrcVector;
...
void TExpMesh::TransformMatrix(D3DXMATRIX* pDestMatrix, const D3DXMATRIX* pSrcMatrix) const
{
