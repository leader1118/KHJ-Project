...
HRESULT sWrite::CreateDeviceIndependentResources()
{
	HRESULT hr;
...
HRESULT sWrite::CreateDeviceResources(IDXGISurface* pSurface)
{
	HRESULT hr;
...
HRESULT sWrite::DrawText(RECT rt, const TCHAR* pText, D2D1::ColorF color)
{
	m_pRT->BeginDraw();
...
void    sWrite::OnResize(int iWidth, int iHeight, IDXGISurface* pSurface)
{
	DiscardDeviceResources();
	CreateDeviceResources(pSurface);
}
void sWrite::DiscardDeviceResources()
{
