...
namespace DX
{
	ID3D11BlendState* sDxState::g_pBSNoBlend = 0;
	ID3D11BlendState* sDxState::g_pBSAlphaBlend = 0;

	ID3D11DepthStencilState*   sDxState::g_pDSVStateEnableLessEqual = 0;
	ID3D11DepthStencilState*   sDxState::g_pDSVStateEnableGreater = 0;
	ID3D11DepthStencilState*   sDxState::g_pDSVStateDetphWriteDisable = 0;
	...
	ID3D11RasterizerState* sDxState::g_pRSBackCullWireFrame = 0;
	ID3D11RasterizerState* sDxState::g_pRSFrontCullWireFrame = 0;
	ID3D11RasterizerState* sDxState::g_pRSNoneCullWireFrame = 0;
