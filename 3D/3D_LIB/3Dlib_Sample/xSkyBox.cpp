...
HRESULT xSkyBox::LoadTexture(T_STR  szName)
{
	...
	{
		L"../../Sampleinclude/data/st00_cm_front.bmp",
		L"../../Sampleinclude/data/st00_cm_back.bmp",
		L"../../Sampleinclude/data/st00_cm_right.bmp",
		L"../../Sampleinclude/data/st00_cm_left.bmp",
		L"../../Sampleinclude/data/st00_cm_up.bmp",
		L"../../Sampleinclude/data/st00_cm_down.bmp"
	};
