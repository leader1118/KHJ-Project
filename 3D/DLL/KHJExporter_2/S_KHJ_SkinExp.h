...
class S_KHJ_SkinExp : public TSingleton<S_KHJ_SkinExp>
{
private:
	friend class TSingleton<S_KHJ_SkinExp>;
public:
	SScene		m_Scene;
	// 정점 가중치 리스트
...
public:
	S_KHJ_SkinExp(void);
	virtual ~S_KHJ_SkinExp(void);
};
#define I_SkinExp S_KHJ_SkinExp::GetInstance()
